...
The model has accuracy of 99.3% and took `r calctime[3]` seconds of elapsed time and `r calctime[2]` seconds of system time.
  
The 
```{r "evaluate test data", echo=2}
